  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        placeholder=""
        type={type}
        className={`w-full rounded-md border-2 bg-white p-4 pt-6 font-light transition outline-none disabled:cursor-not-allowed disabled:opacity-70 ${formatPrice ? 'pl-9' : 'pl-4'} ${errors[id] ? 'border-rose-500' : 'border-neutral-300'} ${errors[id] ? 'focus:border-rose-500' : 'focus:border-black'} `}
      />
      <label
